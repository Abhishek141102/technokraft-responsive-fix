import { GoalItem, FrameworkStep, MetricItem, IndustryItem, ProjectCard, TestimonialItem, RoadmapPhase } from '../types';
...
export const PORTFOLIO_PROJECTS: ProjectCard[] = [
  {
    ...
    subtitle: 'Custom enterprise ERP and operational growth platform architected for strategic account orchestration and revenue milestones.',
  ...
  },
  {
    ...
    subtitle: 'Student management, fee collections, batch attendance, and academic examination analytics portal across 10+ course streams.',
  ...
  },
  {
    ...
    subtitle: 'High-capacity freight logistics system tracking 39,000+ Lorry Receipts, driver allocations, rate cards, and automated billing.',
  ...
  },
  {
    ...
    subtitle: 'Luxury fragrance e-commerce web application with interactive custom perfume builder, seamless checkout, and scent discovery.',
  ...
  },
  {
    ...
    subtitle: 'Admin + college dashboard with punch-in/punch-out, Jira-style task records, intern tracking, and email support.',
  ...
  },
  {
    ...
    subtitle: 'End-to-end workflow from enquiry to admission & fees, automated certificate generation, and reporting.',
  ...
  },
  {
    ...
    subtitle: 'Student + admin dashboards for live lectures, video materials, progress analytics, and auto certificate generation.',
  ...
  },
  {
    ...
    subtitle: 'Mobile companion application for interns and supervisors for quick attendance logging, task tracking, and alerts.',
    industry: 'Educational Institutions',
    goal: 'Automate',
  ...
  },
  {
    ...
    subtitle: 'On-the-go CRM mobile app providing sales and counsellors instant access to student leads, follow-ups, and fee status.',
  ...
  },
  {
    ...
    subtitle: 'Enterprise assessment platform with student & admin portals, timed mock tests, question banks, and instant grading.',
  ...
  },
  {
    ...
    subtitle: 'Comprehensive examination conduction system with student + admin dashboards, email reports, and training evaluation.',
  ...
  },
  {
    ...
    subtitle: 'NLP & Machine Learning system classifying sentiment across millions of reviews and predicting product rating risk trends.',
  ...
  },
  {
    ...
    subtitle: 'Machine Learning models analyzing startup market data to forecast funding probability and estimate round amounts.',
...
export const TESTIMONIALS: TestimonialItem[] = [
  ...
  },
  {
    id: '2',
    quote:
      "Their team is professional, proactive and delivery-focused. They don't just build solutions, they became part of our growth journey.",
    author: 'Sneha Mehta',
    role: 'CEO',
    company: 'Vijayanand Hospital',
