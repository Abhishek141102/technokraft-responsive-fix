            ...
            {service.office && (
              ...
              >
                ...
                <div className="mt-7 grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm">
                  ...
                  <div className="flex gap-3"><Phone className="w-5 h-5 text-blue-600 shrink-0" /><div><p className="font-semibold text-slate-900">Phone Inquiries</p><a href="tel:+918408000048" className="mt-1 inline-block text-slate-600 hover:text-blue-600">{service.office.phone}</a></div></div>
